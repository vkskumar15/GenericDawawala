...
import com.example.genericdawawalauser.modalClass.TimeSlotsModels.AfternoonSlotsModel;

import java.util.ArrayList;
import java.util.List;

public class GridViewSelectAfternoonSlotAdapter extends BaseAdapter {
    private Context context;
    private List<AfternoonSlotsModel> timeList;
    ...
    public GridViewSelectAfternoonSlotAdapter(Context context, List<AfternoonSlotsModel> timeList, Select select) {
...
//        textView.setText(timeList.get(position).getSlot_time());
    ...
    private void getSlotsList(List<AfternoonSlotsModel> list) {
